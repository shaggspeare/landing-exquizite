        ...
        <div className="grid lg:grid-cols-[1.2fr,1fr] gap-8 lg:gap-20 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            <div className="flex flex-col sm:flex-row lg:justify-start justify-center gap-4">
              ...
              <a
                href="https://app.www.exquizite.app/"
          ...
          <div className="relative mx-auto max-w-[1000px] h-[300px] md:h-[600px] flex justify-center items-start">

          {/* Quiz Screen (Back) */}
          <div className="absolute left-1/2 -translate-x-[100px] md:-translate-x-[140px] z-10 w-[160px] md:w-[280px] transition-transform hover:z-40 hover:scale-105 duration-300">
             <div className="rounded-[2.5rem] border-[6px] md:border-8 border-slate-900 overflow-hidden shadow-2xl bg-slate-900">
                {/* Notch */}
