        ...
        createHtmlPlugin({
          ...
          inject: {
            data: {
              ...
              ogImage: 'https://exquizite-app.vercel.app/images/og-image.png',
              ogUrl: 'https://exquizite-app.vercel.app/',
              ...
              twitterImage: 'https://exquizite-app.vercel.app/images/twitter-card.png',
            }
          }
        })
      ],
